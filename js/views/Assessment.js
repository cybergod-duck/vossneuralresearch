      ...
      let html = `
        <div style="text-align: center; max-width: 500px; margin: 0 auto; padding-top: 2rem;">
          ...
          <div style="display:flex; gap: 15px; justify-content: center;">
            <button class="styled-btn btn-answer" data-val="3" style="width:120px;">Often</button>
            <button class="styled-btn btn-answer" data-val="1" style="width:120px;">Sometimes</button>
            <button class="styled-btn btn-answer" data-val="0" style="width:120px;">Rarely</button>
          </div>
        </div>
      `;
